...
const Footer = () => {
  ...
  return (
    <div>
      <div
        className=" lg-pt-[70px] sm:pt-[20px] "
        style={{
      ...
      >
        <div className="  w-container  ">
          ...
          <div className="w-full flex justify-center">
            <div className=" 2xl:w-[70%] lg:w-[90%]  grid sm:grid-cols-2 gap-10 sm:gap-14 md:grid-cols-2 lg:grid-cols-4 px-2">
              <div
                id="w-node-_6e965b4c-a72d-e35f-24f8-0924edf57488-91406018"
                className="flex justify-center flex-col items-center self-start"
              >
                ...
                <div className="ft-link-blocks ">
                  <Link
                    ...
                    className="flex lg:justify-start xxxs:justify-center items-center mb-2"
                  >
                    <Image
                      src={phone}
                      loading="lazy"
                      ...
                      className="image"
                    />
                    <div className="ml-3 text-[#aeaeae]">
                      {/* +61 */}
                      0475261278
                    </div>
                  </Link>
              ...
              <div className=" flex justify-center ">
                <div className="ft-link-blocks ">
                  <div className="text-[#f4d472] text-2xl font-serif ">
                    Links
                  </div>
              ...
              <div className=" flex flex-col self-start justify-center items-center ">
                <div className="ft-link-blocks">
                  <div className="text-[#f4d472] text-2xl font-serif xxxs:text-center lg:text-start  ">
                    Locations
                  </div>
                  {/* <Link
                  href="tel:+61475261278"
                ...
                >
                  ...
                  <div className="address-block">
                    <Image
                      ...
                      alt="location symbol"
                    />
                    <div className="flex justify-center items-center text-[#aeaeae] ml-2">
                      Cairns, QLD, 4870
                    </div>
                  </div>
                </div>
